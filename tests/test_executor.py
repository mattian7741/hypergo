...
class TestExecutor(unittest.TestCase):
    def _get_standard_configs(self) -> None:
        return ConfigType({"namespace": "datalink",
                           "name": "testappliance",
                           ...
                           "input_json_schema": {"$schema": "http://json-schema.org/draft-04/schema#",
                                                 ...
                                                 "properties": {"string_field": {"type": "string"},
                                                                ...
                                                                "nested_field": {"type": "object",
                                                                                 "properties": {"nested_string_field": {"type": "string"}},
                                                                                 "required": ["nested_string_field"]},
                                                                "array_field": {"type": "array",
                                                                                "items": [{"type": "string"}]},
                                                                "not_required_field": {"type": "string"}},
    ...
    def test_input_json_schema_happy_path(self) -> None:
        with (mock.patch.object(Executor, "func_spec"), mock.patch.object(Executor, "open_envelope")):
